 ...
 */
const ConstraintBuilder = ({ parameters, onAddConstraint, onCancel }) => {
      ...
      <Card.Header>
        <div className="d-flex justify-content-between align-items-center">
          ...
          <Form.Select
            ...
            onChange={(e) =>
              setConstraintType(e.target.value as "simple" | "if-then")
            }
          >
