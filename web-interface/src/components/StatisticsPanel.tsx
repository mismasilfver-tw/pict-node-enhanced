...
function StatisticsPanel({
  ...
  return (
    <>
      <Card className="mb-3" data-testid="statistics-panel">
        ...
        <Card.Body>
          ...
          {showDetails && (
            <Row className="mb-2">
              <Col sm={6} data-testid="efficiency-row">
              ...
              <Col sm={6} data-testid="constraint-reduction-row">
        ...
        <Modal.Body>
          <div className="mb-4">
            ...
            <p className="text-muted mb-3">
              Determines n-way coverage. Order 2 means pairwise testing (all
              pairs of parameter values), order 3 means 3-way testing (all
              triplets), and so on.
            </p>
            ...
            <p className="text-muted mb-3">
              The number of test cases that PICT generated to achieve the
              desired coverage.
            </p>
            ...
            <p className="text-muted mb-1">
              The total number of possible n-way combinations for your
              parameters. This represents the exhaustive testing approach.
            </p>
            <p className="mb-3">
              <a
                href="/theoretical-maximum"
                target="_blank"
            ...
            <p className="text-muted mb-3">
              The percentage of theoretical combinations that are covered by the
              generated test suite. PICT aims for 100% coverage but may achieve
              slightly less due to optimization.
            </p>
            ...
            <p className="text-muted mb-3">
              How well PICT optimized the test suite. High efficiency means
              fewer tests while maintaining good coverage.
            </p>
            ...
            <p className="text-muted mb-3">
              The percentage reduction in possible combinations due to
              constraints. Higher values indicate more restrictive constraints.
            </p>
          </div>
          ...
          <div className="bg-light p-3 rounded">
            <h6>Example:</h6>
            <p className="mb-1">
              <strong>Scenario:</strong> 3 parameters, each with 3 values, 2-way
              coverage
            </p>
            <p className="mb-1">
