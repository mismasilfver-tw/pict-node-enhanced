    ...
    <Container className="py-4">
      ...
      <Card className="shadow-sm mb-4">
        ...
        <Card.Body>
          ...
          <p className="lead">
            The "Theoretical Maximum" in the statistics refers to the total number of unique <strong>pairs</strong> that need to be covered in 2-way testing, not the total number of test cases.
          </p>
          ...
          <p>If we tested every possible combination (exhaustive testing), we'd need:</p>
          <p className="text-center fs-4">
            3 (Browser) × 3 (Device) × 2 (OS) = <strong>18 test cases</strong>
          </p>

          <h5>2. Pairwise (2-way) Testing</h5>
          <p>In pairwise testing, we count the number of unique value pairs between all parameter combinations:</p>
          
          <div className="ms-4">
            <p><strong>Browser × Device</strong>: 3 × 3 = 9 pairs</p>
            <p><strong>Browser × OS</strong>: 3 × 2 = 6 pairs</p>
            <p><strong>Device × OS</strong>: 3 × 2 = 6 pairs</p>
          ...
          <div className="alert alert-info mt-4">
            ...
            <p className="mb-0">
              The power of pairwise testing is that we can cover all these 21 pairs with many fewer than 18 test cases 
              (typically around 9-12 tests). This is the efficiency that the tool demonstrates in the statistics.
            </p>
          </div>
